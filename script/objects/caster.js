...
CASTERBASES[CASTER_TYPE.PEWPEW] = 
    new CasterBase(CASTER_TYPE.PEWPEW, 10, 1, 0.90, 1, 10);

CASTERBASES[CASTER_TYPE.RATATAT] = 
    new CasterBase(CASTER_TYPE.RATATAT, 6, 1.30, 0.85, 0.85, 30);

CASTERBASES[CASTER_TYPE.DERTDERT] = 
    new CasterBase(CASTER_TYPE.DERTDERT, 4, 1.60, 0.80, 0.90, 20);

CASTERBASES[CASTER_TYPE.BLAMBLAM] = 
    new CasterBase(CASTER_TYPE.BLAMBLAM, 30, 0.70, 0.70, 0.80, 6);

CASTERBASES[CASTER_TYPE.KABOOMER] = 
    new CasterBase(CASTER_TYPE.KABOOMER, 100, 0.20, 0.85, 0.50, 3);
...
function generate_caster(level) {
    ...
    accuracy = parseFloat(contain_number(accuracy, 1, 100).toFixed(2));
